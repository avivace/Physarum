...
\begin{figure}[H]
    \centering
    \subfigure[MST of network with 20 nodes]{\includegraphics[width=0.40\textwidth]{mst_20}} 
    \subfigure[Experimental result of simulation network with 20 nodes]{\includegraphics[width=0.40\textwidth]{wsn_20_exp/4_wsn_20}} 
    \subfigure[MST of network with 40 nodes]{\includegraphics[width=0.40\textwidth]{mst_40}} 
    \subfigure[Experimental result of simulation network with 40 nodes]{\includegraphics[width=0.40\textwidth]{wsn_40_exp/4_wsn_40}} 
...
\begin{figure}[H]
    \centering
    \subfigure[MST of second maze]{\includegraphics[width=0.40\textwidth]{mst_tube}} 
    \subfigure[Experimental result of second maze]{\includegraphics[width=0.40\textwidth]{generic_maze_exp/4_generic_maze}} 
