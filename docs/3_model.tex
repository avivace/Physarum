...
The model introduced in the previous section considers only slime mould foraging behaviour and also - with the only information in the paper - seems not to follow the true behavior of slime mould; the main problems encountered can be summarized in the following points:
...
For this reason we have proposed an alternative model - starting from the Tsompanas et al. \cite{Tsompanas2016} work - that aims at a more faithful exploration of slime mould. It is introduced in the next section.
