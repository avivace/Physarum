...
When considering two-dimensional CA, the \textit{von Neumann} and the \texit{Moore} neighborhoods are often used.

\paragraph{Moore neighborhood}

The d-dimensional radius-r Moore neighboorhood, containing $(2r +1)^d$ is defined as follows:
